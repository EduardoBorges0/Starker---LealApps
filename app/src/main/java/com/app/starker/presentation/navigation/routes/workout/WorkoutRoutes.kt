...
sealed class WorkoutRoutes(
    ...
    object InsertWorkoutImage :
        WorkoutRoutes("insert_workout_image/{workoutName}/{workoutDescription}/{date}") {
        fun createRoute(workoutName: String, workoutDescription: String, date: String): String {
            ...
            val encodedDescription =
                URLEncoder.encode(workoutDescription, StandardCharsets.UTF_8.toString())
    ...
    object UpdateWorkout :
        WorkoutRoutes("update_workout/{workoutId}/{workoutName}/{workoutDescription}/{date}") {
        fun createRoute(
            workoutId: String,
            workoutName: String,
            ...
            val encodedDescription =
                URLEncoder.encode(workoutDescription, StandardCharsets.UTF_8.toString())
            val encodedDate = URLEncoder.encode(date, StandardCharsets.UTF_8.toString())
            return "update_workout/$workoutId/$encodedName/$encodedDescription/$encodedDate"
        }
    }
